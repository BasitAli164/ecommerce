...
export default function Cart({prodDetail}) {
  ...
  return (
    ...
    <div className="w-full flex justify-between ">
      ...
      <div className="flex flex-col justify-center items-center gap-1 mr-3 mt-3">
    ...
    <div style={{backgroundImage:`url(${prodDetail.image})`, backgroundPosition:"center", backgroundRepeat:"no-repeat" ,backgroundSize:"cover"}} className="w-[200px] h-[200px]"></div>
