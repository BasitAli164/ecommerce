...
export default function Hero() {
  ...
  return (
    <div className="max-w-[400px] w-full sm:w-max-[800px] sm:w-full h-auto  mx-4 my-2 sm:my-0 sm:mx-0   flex flex-col  justify-center items-center bg-primaryText text-secondaryText rounded-lg shadow-2xl sm:p-4 overflow-hidden">
      {data.map((item) => (
