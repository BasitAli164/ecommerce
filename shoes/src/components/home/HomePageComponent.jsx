...
export default function HomePageComponent() {
  ...
  return (
    <div className="w-full h-screen relative overflow-hidden">
      ...
      {/* Content */}
      <div className="absolute inset-0 flex flex-col justify-center items-center gap-5 bg-black/50 px-4 text-white text-center mt-20">
        <div className="flex flex-col justify-center items-center gap-2 max-w-5xl">
          ...
          <p className="text-md sm:text-lg lg:text-xl xl:text-2xl">
            ...
            . Whether you're looking for the latest trends or timeless classics, we have something for everyone. Our
